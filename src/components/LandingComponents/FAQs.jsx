...
const FAQs = () => {
    ...
    return (
        <div className='w-full lg:w-3/4 px-4 lg:px-8 bg-white flex flex-col gap-y-4 md:gap-y-16'>
            <h1 className='text-3xl md:text-5xl font-black uppercase text-black flex flex-col'>Frequently asked <span className='text-primary'>Questions</span></h1>
