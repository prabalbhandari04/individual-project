...
const Doctors = () => {
  return (
    <div className='w-full lg:w-3/4 px-4 lg:px-0 bg-white flex flex-wrap justify-center items-center gap-y-20 md:gap-y-20 mt-20 md:mt-0'>
        <div className='w-full lg:w-1/2 flex justify-center items-center'>
            <h1 className='text-3xl md:text-5xl font-black text-primary uppercase flex flex-col md:flex-initial'>
                Staff 
